...
Revision ID: 608387cc88cd
Revises: 878abb621e21
Create Date: 2025-03-04 14:19:11.969711
...
revision: str = "608387cc88cd"
down_revision: str | None = "878abb621e21"
...
def upgrade() -> None:
    ...
    op.alter_column("asset", "full_path", existing_type=sa.VARCHAR(), nullable=False)
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.alter_column("asset", "full_path", existing_type=sa.VARCHAR(), nullable=True)
    op.create_table(
