...
Revision ID: d548707d180d
Revises:
Create Date: 2025-04-09 15:10:17.071364
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("stimulus_start_time", sa.Float(), nullable=True),
        sa.Column("stimulus_end_time", sa.Float(), nullable=True),
