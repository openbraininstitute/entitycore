...
Revision ID: 5802e5035fd4
Revises: 54eb4d0782bf
Create Date: 2025-07-18 14:41:20.348144
...
def upgrade() -> None:
    ...
    op.drop_constraint(op.f("uq_etype_per_entity"), "etype_classification", type_="unique")
    op.drop_constraint(op.f("uq_mtype_per_entity"), "mtype_classification", type_="unique")
...
def downgrade() -> None:
    ...
    op.create_unique_constraint(
        op.f("uq_mtype_per_entity"),
        "mtype_classification",
        ["entity_id", "mtype_class_id"],
        postgresql_nulls_not_distinct=False,
    )
    op.create_unique_constraint(
        op.f("uq_etype_per_entity"),
        "etype_classification",
        ["entity_id", "etype_class_id"],
        postgresql_nulls_not_distinct=False,
    )
    op.add_column(
        "electrical_cell_recording",
