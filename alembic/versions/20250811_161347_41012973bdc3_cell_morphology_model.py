...
def _add_cell_morphology_description_vector():
...
def _remove_cell_morphology_cell_morphology_description_vector():
    public_cell_morphology_cell_morphology_description_vector = PGTrigger(
        schema="public",
        signature="cell_morphology_description_vector",
        on_entity="public.cell_morphology",
...
def upgrade() -> None:
    ...
    _add_cell_morphology_description_vector()
...
def downgrade() -> None:
    ...
    _remove_cell_morphology_cell_morphology_description_vector()
