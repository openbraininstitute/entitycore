...
Revision ID: 6faf27574455
Revises: 30f66941ec3b
Create Date: 2026-04-24 15:13:55.613211
...
def upgrade() -> None:
    ...
    sa.Enum(
        "neuropixels_v1", "neuropixels_v2", "neuropixels_ultra", "custom", name="electrodetype"
    ).create(op.get_bind())
    op.create_table(
