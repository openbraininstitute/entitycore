...
Revision ID: ca1bc36a998f
Revises: 696482acc02c
Create Date: 2026-06-09 16:43:31.657052
...
def upgrade() -> None:
    ...
    sa.Enum("task_result", name="taskresulttype").create(op.get_bind())
    op.create_table(
        "task_result",
        sa.Column("id", sa.Uuid(), nullable=False),
        sa.Column(
            "task_result_type",
            postgresql.ENUM("task_result", name="taskresulttype", create_type=False),
            nullable=False,
        ),
        sa.Column(
            "data_payload",
...
def downgrade() -> None:
    ...
    sa.Enum("task_result", name="taskresulttype").drop(op.get_bind())
    # ### end Alembic commands ###
