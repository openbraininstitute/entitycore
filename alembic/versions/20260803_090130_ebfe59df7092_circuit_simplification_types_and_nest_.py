"""circuit simplification types and NEST target simulator

Revision ID: ebfe59df7092
Revises: 318a78fa6cfb
Create Date: 2026-08-03 09:01:30.200518
...
def upgrade() -> None:
    ...
    op.sync_enum_values(
        ...
        new_values=["Brian2", "CORENEURON", "LearningEngine", "NEST", "NEURON"],
        affected_columns=[
            TableReference(
                table_schema="public",
                table_name="circuit",
