...
def curate_person(person):
    if name := person.get("name", ""):
        if name == "Weina Ji":
            person["given_name"] = "Weina"
            person["family_name"] = "Ji"
        elif name == "None None":  # noqa: SIM114
            person["given_name"] = "bbp-dke-bluebrainatlas-sa"
            person["family_name"] = "bbp-dke-bluebrainatlas-sa"
