...
from app.filters.ion_channel_modeling import NestedIonChannelModelingFilter, NestedIonChannelModelingFilterDep


class IonChannelModelingCampaignFilter(CustomFilter, EntityFilterMixin, NameFilterMixin):
    ion_channel_modeling: Annotated[NestedIonChannelModelingFilter | None, NestedIonChannelModelingFilterDep] = None
