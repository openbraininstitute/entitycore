...
update_one = router.patch("/{id_}")(app.service.cell_morphology_protocol.update_one)
delete_one = router.delete("/{id_}")(app.service.cell_morphology_protocol.delete_one)
