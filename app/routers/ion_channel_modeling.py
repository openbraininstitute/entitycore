...
import app.service.ion_channel_modeling
from app.routers.admin import router as admin_router

ROUTE = "ion-channel-modeling"
router = APIRouter(prefix=f"/{ROUTE}", tags=[ROUTE])

read_many = router.get("")(app.service.ion_channel_modeling.read_many)
read_one = router.get("/{id_}")(app.service.ion_channel_modeling.read_one)
create_one = router.post("")(app.service.ion_channel_modeling.create_one)
