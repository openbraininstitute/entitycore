import app.service.ion_channel_modeling_config_generation as service
from app.routers.admin import router as admin_router
from app.routers.common import create_user_router, register_default_admin_routes
from app.types import ActivityRoute

ROUTE = ActivityRoute.ion_channel_modeling_config_generation
