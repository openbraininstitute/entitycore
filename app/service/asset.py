...
def entity_asset_upload_abort(
    *,
    ...
    # delete db entry for uploading asset
    # Note: This works with the asset delete event that tries to delete the non-existing file and
    # throws an exception which is captured and logged. TODO: Handle this better
    repos.db.delete(asset_db)
