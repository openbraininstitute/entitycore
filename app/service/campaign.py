...
from app.filters.campaign import CampaignFilterDep
...
from app.queries.constants import NESTED_CAMPAIGN_RELATIONSHIPS
...
DBModel = Campaign
ReadSchema = CampaignRead
CreateSchema = CampaignCreate
UserUpdateSchema = CampaignUserUpdate
AdminUpdateSchema = CampaignAdminUpdate
FilterDep = CampaignFilterDep
...
def create_one(
    ...
    return router_create_one(
        ...
        response_schema_class=ReadSchema,
        apply_operations=_load,
        nested_relationships=NESTED_CAMPAIGN_RELATIONSHIPS,
    )
...
def read_many(
    ...
    task_config_alias = aliased(TaskConfig, flat=True)
    aliases: Aliases = {
        Agent: {
