...
from app.db.model import Agent, CircuitExtractionConfigGeneration, Entity
...
from app.filters.circuit_extraction_config_generation import (
    CircuitExtractionConfigGenerationFilterDep,
)
...
from app.schemas.circuit_extraction_config_generation import (
...
def _load(query: sa.Select):
    return query.options(
        joinedload(CircuitExtractionConfigGeneration.used),
        joinedload(CircuitExtractionConfigGeneration.generated),
        joinedload(CircuitExtractionConfigGeneration.created_by),
        joinedload(CircuitExtractionConfigGeneration.updated_by),
        raiseload("*"),
    )
...
def create_one(
    db: SessionDep,
    json_model: CircuitExtractionConfigGenerationCreate,
...
def read_many(
    ...
    filter_model: CircuitExtractionConfigGenerationFilterDep,
