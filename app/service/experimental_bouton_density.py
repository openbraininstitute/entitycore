...
def read_many(
    ...
    apply_filter_query = lambda query: (
        ...
        .outerjoin(Species, ExperimentalBoutonDensity.species_id == Species.id)
        .outerjoin(Strain, ExperimentalBoutonDensity.strain_id == Strain.id)
    ...
    apply_data_options = lambda query: (
        ...
        .options(joinedload(ExperimentalBoutonDensity.species, innerjoin=True))
        .options(
        ...
        .options(joinedload(ExperimentalBoutonDensity.strain))
...
def read_one(
    ...
    return router_read_one(
        ...
        apply_operations=lambda q: q.options(
            ...
            joinedload(ExperimentalBoutonDensity.species),
            joinedload(ExperimentalBoutonDensity.strain),
