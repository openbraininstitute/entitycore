...
def read_many(
    ...
    name_to_facet_query_params: dict[str, FacetQueryParams] = (
        fc.brain_region | fc.species | fc.strain | aliased_facets
    )
    ...
    apply_filter_query = lambda query: (
        ...
        .outerjoin(created_by_alias, db_cls.createdBy_id == created_by_alias.id)
        .outerjoin(updated_by_alias, db_cls.updatedBy_id == updated_by_alias.id)
    )
