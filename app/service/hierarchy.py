...
def _load_nodes(
    ...
    matching_derivation_for_root = constrain_to_readable_entities_by_project(
    ...
    query_roots = constrain_to_readable_entities_by_project(
    ...
    query_children = constrain_to_readable_entities_by_project(
