...
from app.filters.classification import MTypeClassificationFilterDep
...
def _load(query: sa.Select):
    return query.options(
        joinedload(MTypeClassification.created_by),
        joinedload(MTypeClassification.updated_by),
        raiseload("*"),
    )
...
def create_one(
    ...
    # allow entities that are in the same project as the classification
