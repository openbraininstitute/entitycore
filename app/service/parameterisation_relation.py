...
from app.db.model import ParameterisationRelation, Person, Subject
from app.dependencies.auth import UserContextDep, UserContextWithProjectIdDep
from app.dependencies.common import FacetsDep, InBrainRegionDep, PaginationQuery, SearchDep
from app.dependencies.db import SessionDep
from app.filters.parameterisation_relation import ParameterisationRelationFilterDep
...
from app.schemas.parameterisation_relation import (
    ParameterisationRelationAdminUpdate,
    ParameterisationRelationCreate,
    ParameterisationRelationRead,
...
def _load(q: Select[ParameterisationRelation]) -> Select[ParameterisationRelation]:
...
def read_one(
    ...
    return router_read_one(
        ...
        response_schema_class=ParameterisationRelationRead,
...
def create_one(
    ...
    db: SessionDep,
    json_model: ParameterisationRelationCreate,
) -> ParameterisationRelationRead:
...
def update_one(
    ...
    db: SessionDep,
    id_: uuid.UUID,
    json_model: ParameterisationRelationUserUpdate,  # pyright: ignore [reportInvalidTypeForm]
) -> ParameterisationRelationRead:
...
def admin_update_one(
    db: SessionDep,
    id_: uuid.UUID,
    json_model: ParameterisationRelationAdminUpdate,  # pyright: ignore [reportInvalidTypeForm]
) -> ParameterisationRelationRead:
    return router_update_one(
        id_=id_,
        db=db,
...
def read_many(
    ...
    filter_model: ParameterisationRelationFilterDep,
    with_search: SearchDep,
    in_brain_region: InBrainRegionDep,
    facets: FacetsDep,
) -> ListResponse[ParameterisationRelationRead]:
