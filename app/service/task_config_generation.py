...
from app.db.model import Entity, Person, TaskConfigGeneration
...
from app.filters.task_config_generation import (
    TaskConfigGenerationFilterDep,
)
...
from app.schemas.task_config_generation import (
    TaskConfigGenerationAdminUpdate,
    TaskConfigGenerationCreate,
    TaskConfigGenerationRead,
    TaskConfigGenerationUserUpdate,
)
...
DBModel = TaskConfigGeneration
ReadSchema = TaskConfigGenerationRead
CreateSchema = TaskConfigGenerationCreate
UserUpdateSchema = TaskConfigGenerationUserUpdate
AdminUpdateSchema = TaskConfigGenerationAdminUpdate
FilterDep = TaskConfigGenerationFilterDep
