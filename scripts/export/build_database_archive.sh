...
set -euo pipefail
SCRIPT_VERSION="1"
SCRIPT_DB_VERSION="108948e19fcc"
...
\echo Dumping table activity_version
\copy (SELECT t0.* FROM activity_version AS t0  WHERE t0.authorized_public IS true) TO '$DATA_DIR/activity_version.csv' WITH CSV HEADER;
\echo Dumping table agent
\copy (SELECT t0.* FROM agent AS t0  WHERE TRUE) TO '$DATA_DIR/agent.csv' WITH CSV HEADER;
\echo Dumping table agent_version
\copy (SELECT t0.* FROM agent_version AS t0  WHERE TRUE) TO '$DATA_DIR/agent_version.csv' WITH CSV HEADER;
...
\echo Dumping table analysis_notebook_environment_version
\copy (SELECT t0.* FROM analysis_notebook_environment_version AS t0  WHERE TRUE) TO '$DATA_DIR/analysis_notebook_environment_version.csv' WITH CSV HEADER;
...
\echo Dumping table analysis_notebook_execution_version
\copy (SELECT t0.* FROM analysis_notebook_execution_version AS t0  WHERE TRUE) TO '$DATA_DIR/analysis_notebook_execution_version.csv' WITH CSV HEADER;
...
\echo Dumping table analysis_notebook_result_version
\copy (SELECT t0.* FROM analysis_notebook_result_version AS t0  WHERE TRUE) TO '$DATA_DIR/analysis_notebook_result_version.csv' WITH CSV HEADER;
...
\echo Dumping table analysis_notebook_template_version
\copy (SELECT t0.* FROM analysis_notebook_template_version AS t0  WHERE TRUE) TO '$DATA_DIR/analysis_notebook_template_version.csv' WITH CSV HEADER;
...
\echo Dumping table analysis_software_source_code_version
\copy (SELECT t0.* FROM analysis_software_source_code_version AS t0  WHERE TRUE) TO '$DATA_DIR/analysis_software_source_code_version.csv' WITH CSV HEADER;
...
\echo Dumping table annotation_body_version
\copy (SELECT t0.* FROM annotation_body_version AS t0  WHERE TRUE) TO '$DATA_DIR/annotation_body_version.csv' WITH CSV HEADER;
\echo Dumping table annotation_version
\copy (SELECT t0.* FROM annotation_version AS t0  WHERE TRUE) TO '$DATA_DIR/annotation_version.csv' WITH CSV HEADER;
...
\echo Dumping table asset_version
\copy (SELECT t0.* FROM asset_version AS t0  WHERE TRUE) TO '$DATA_DIR/asset_version.csv' WITH CSV HEADER;
...
\echo Dumping table brain_atlas_region_version
\copy (SELECT t0.* FROM brain_atlas_region_version AS t0  WHERE TRUE) TO '$DATA_DIR/brain_atlas_region_version.csv' WITH CSV HEADER;
\echo Dumping table brain_atlas_version
\copy (SELECT t0.* FROM brain_atlas_version AS t0  WHERE TRUE) TO '$DATA_DIR/brain_atlas_version.csv' WITH CSV HEADER;
...
\echo Dumping table brain_region_hierarchy_version
\copy (SELECT t0.* FROM brain_region_hierarchy_version AS t0  WHERE TRUE) TO '$DATA_DIR/brain_region_hierarchy_version.csv' WITH CSV HEADER;
\echo Dumping table brain_region_version
\copy (SELECT t0.* FROM brain_region_version AS t0  WHERE TRUE) TO '$DATA_DIR/brain_region_version.csv' WITH CSV HEADER;
...
\echo Dumping table calibration_version
\copy (SELECT t0.* FROM calibration_version AS t0  WHERE TRUE) TO '$DATA_DIR/calibration_version.csv' WITH CSV HEADER;
...
\echo Dumping table cell_composition_version
\copy (SELECT t0.* FROM cell_composition_version AS t0  WHERE TRUE) TO '$DATA_DIR/cell_composition_version.csv' WITH CSV HEADER;
...
\echo Dumping table cell_morphology_protocol_version
\copy (SELECT t0.* FROM cell_morphology_protocol_version AS t0  WHERE TRUE) TO '$DATA_DIR/cell_morphology_protocol_version.csv' WITH CSV HEADER;
\echo Dumping table cell_morphology_version
\copy (SELECT t0.* FROM cell_morphology_version AS t0  WHERE TRUE) TO '$DATA_DIR/cell_morphology_version.csv' WITH CSV HEADER;
...
\echo Dumping table circuit_extraction_campaign_version
\copy (SELECT t0.* FROM circuit_extraction_campaign_version AS t0  WHERE TRUE) TO '$DATA_DIR/circuit_extraction_campaign_version.csv' WITH CSV HEADER;
...
\echo Dumping table circuit_extraction_config_generation_version
\copy (SELECT t0.* FROM circuit_extraction_config_generation_version AS t0  WHERE TRUE) TO '$DATA_DIR/circuit_extraction_config_generation_version.csv' WITH CSV HEADER;
\echo Dumping table circuit_extraction_config_version
\copy (SELECT t0.* FROM circuit_extraction_config_version AS t0  WHERE TRUE) TO '$DATA_DIR/circuit_extraction_config_version.csv' WITH CSV HEADER;
...
\echo Dumping table circuit_extraction_execution_version
\copy (SELECT t0.* FROM circuit_extraction_execution_version AS t0  WHERE TRUE) TO '$DATA_DIR/circuit_extraction_execution_version.csv' WITH CSV HEADER;
\echo Dumping table circuit_version
\copy (SELECT t0.* FROM circuit_version AS t0  WHERE TRUE) TO '$DATA_DIR/circuit_version.csv' WITH CSV HEADER;
\echo Dumping table consortium
\copy (SELECT t0.* FROM consortium AS t0  WHERE TRUE) TO '$DATA_DIR/consortium.csv' WITH CSV HEADER;
\echo Dumping table consortium_version
\copy (SELECT t0.* FROM consortium_version AS t0  WHERE TRUE) TO '$DATA_DIR/consortium_version.csv' WITH CSV HEADER;
...
\echo Dumping table contribution_version
\copy (SELECT t0.* FROM contribution_version AS t0  WHERE TRUE) TO '$DATA_DIR/contribution_version.csv' WITH CSV HEADER;
...
\echo Dumping table datamaturity_annotation_body_version
\copy (SELECT t0.* FROM datamaturity_annotation_body_version AS t0  WHERE TRUE) TO '$DATA_DIR/datamaturity_annotation_body_version.csv' WITH CSV HEADER;
...
\echo Dumping table derivation_version
\copy (SELECT t0.* FROM derivation_version AS t0  WHERE TRUE) TO '$DATA_DIR/derivation_version.csv' WITH CSV HEADER;
...
\echo Dumping table electrical_cell_recording_version
\copy (SELECT t0.* FROM electrical_cell_recording_version AS t0  WHERE TRUE) TO '$DATA_DIR/electrical_cell_recording_version.csv' WITH CSV HEADER;
...
\echo Dumping table electrical_recording_stimulus_version
\copy (SELECT t0.* FROM electrical_recording_stimulus_version AS t0  WHERE TRUE) TO '$DATA_DIR/electrical_recording_stimulus_version.csv' WITH CSV HEADER;
\echo Dumping table electrical_recording_version
\copy (SELECT t0.* FROM electrical_recording_version AS t0  WHERE TRUE) TO '$DATA_DIR/electrical_recording_version.csv' WITH CSV HEADER;
...
\echo Dumping table em_cell_mesh__skeletonization_campaign_version
\copy (SELECT t0.* FROM em_cell_mesh__skeletonization_campaign_version AS t0  WHERE TRUE) TO '$DATA_DIR/em_cell_mesh__skeletonization_campaign_version.csv' WITH CSV HEADER;
\echo Dumping table em_cell_mesh_version
\copy (SELECT t0.* FROM em_cell_mesh_version AS t0  WHERE TRUE) TO '$DATA_DIR/em_cell_mesh_version.csv' WITH CSV HEADER;
...
\echo Dumping table em_dense_reconstruction_dataset_version
\copy (SELECT t0.* FROM em_dense_reconstruction_dataset_version AS t0  WHERE TRUE) TO '$DATA_DIR/em_dense_reconstruction_dataset_version.csv' WITH CSV HEADER;
...
\echo Dumping table emodel_version
\copy (SELECT t0.* FROM emodel_version AS t0  WHERE TRUE) TO '$DATA_DIR/emodel_version.csv' WITH CSV HEADER;
...
\echo Dumping table entity_version
\copy (SELECT t0.* FROM entity_version AS t0  WHERE t0.authorized_public IS true) TO '$DATA_DIR/entity_version.csv' WITH CSV HEADER;
...
\echo Dumping table etype_class_version
\copy (SELECT t0.* FROM etype_class_version AS t0  WHERE TRUE) TO '$DATA_DIR/etype_class_version.csv' WITH CSV HEADER;
...
\echo Dumping table etype_classification_version
\copy (SELECT t0.* FROM etype_classification_version AS t0  WHERE t0.authorized_public IS true) TO '$DATA_DIR/etype_classification_version.csv' WITH CSV HEADER;
...
\echo Dumping table experimental_bouton_density_version
\copy (SELECT t0.* FROM experimental_bouton_density_version AS t0  WHERE TRUE) TO '$DATA_DIR/experimental_bouton_density_version.csv' WITH CSV HEADER;
...
\echo Dumping table experimental_neuron_density_version
\copy (SELECT t0.* FROM experimental_neuron_density_version AS t0  WHERE TRUE) TO '$DATA_DIR/experimental_neuron_density_version.csv' WITH CSV HEADER;
...
\echo Dumping table experimental_synapses_per_connection_version
\copy (SELECT t0.* FROM experimental_synapses_per_connection_version AS t0  WHERE TRUE) TO '$DATA_DIR/experimental_synapses_per_connection_version.csv' WITH CSV HEADER;
...
\echo Dumping table external_url_version
\copy (SELECT t0.* FROM external_url_version AS t0  WHERE TRUE) TO '$DATA_DIR/external_url_version.csv' WITH CSV HEADER;
...
\echo Dumping table generation_version
\copy (SELECT t0.* FROM generation_version AS t0  WHERE TRUE) TO '$DATA_DIR/generation_version.csv' WITH CSV HEADER;
...
\echo Dumping table ion_channel_model__emodel_version
\copy (SELECT t0.* FROM ion_channel_model__emodel_version AS t0  WHERE TRUE) TO '$DATA_DIR/ion_channel_model__emodel_version.csv' WITH CSV HEADER;
\echo Dumping table ion_channel_model_version
\copy (SELECT t0.* FROM ion_channel_model_version AS t0  WHERE TRUE) TO '$DATA_DIR/ion_channel_model_version.csv' WITH CSV HEADER;
...
\echo Dumping table ion_channel_modeling_campaign_version
\copy (SELECT t0.* FROM ion_channel_modeling_campaign_version AS t0  WHERE TRUE) TO '$DATA_DIR/ion_channel_modeling_campaign_version.csv' WITH CSV HEADER;
...
\echo Dumping table ion_channel_modeling_config_generation_version
\copy (SELECT t0.* FROM ion_channel_modeling_config_generation_version AS t0  WHERE TRUE) TO '$DATA_DIR/ion_channel_modeling_config_generation_version.csv' WITH CSV HEADER;
\echo Dumping table ion_channel_modeling_config_version
\copy (SELECT t0.* FROM ion_channel_modeling_config_version AS t0  WHERE TRUE) TO '$DATA_DIR/ion_channel_modeling_config_version.csv' WITH CSV HEADER;
...
\echo Dumping table ion_channel_modeling_execution_version
\copy (SELECT t0.* FROM ion_channel_modeling_execution_version AS t0  WHERE TRUE) TO '$DATA_DIR/ion_channel_modeling_execution_version.csv' WITH CSV HEADER;
...
\echo Dumping table ion_channel_recording__ion_channel_modeling_campaign_version
\copy (SELECT t0.* FROM ion_channel_recording__ion_channel_modeling_campaign_version AS t0  WHERE TRUE) TO '$DATA_DIR/ion_channel_recording__ion_channel_modeling_campaign_version.csv' WITH CSV HEADER;
\echo Dumping table ion_channel_recording_version
\copy (SELECT t0.* FROM ion_channel_recording_version AS t0  WHERE TRUE) TO '$DATA_DIR/ion_channel_recording_version.csv' WITH CSV HEADER;
\echo Dumping table ion_channel_version
\copy (SELECT t0.* FROM ion_channel_version AS t0  WHERE TRUE) TO '$DATA_DIR/ion_channel_version.csv' WITH CSV HEADER;
\echo Dumping table ion_version
\copy (SELECT t0.* FROM ion_version AS t0  WHERE TRUE) TO '$DATA_DIR/ion_version.csv' WITH CSV HEADER;
\echo Dumping table license
\copy (SELECT t0.* FROM license AS t0  WHERE TRUE) TO '$DATA_DIR/license.csv' WITH CSV HEADER;
\echo Dumping table license_version
\copy (SELECT t0.* FROM license_version AS t0  WHERE TRUE) TO '$DATA_DIR/license_version.csv' WITH CSV HEADER;
...
\echo Dumping table me_type_density_version
\copy (SELECT t0.* FROM me_type_density_version AS t0  WHERE TRUE) TO '$DATA_DIR/me_type_density_version.csv' WITH CSV HEADER;
...
\echo Dumping table measurement_annotation_version
\copy (SELECT t0.* FROM measurement_annotation_version AS t0  WHERE TRUE) TO '$DATA_DIR/measurement_annotation_version.csv' WITH CSV HEADER;
...
\echo Dumping table measurement_item_version
\copy (SELECT t0.* FROM measurement_item_version AS t0  WHERE TRUE) TO '$DATA_DIR/measurement_item_version.csv' WITH CSV HEADER;
...
\echo Dumping table measurement_kind_version
\copy (SELECT t0.* FROM measurement_kind_version AS t0  WHERE TRUE) TO '$DATA_DIR/measurement_kind_version.csv' WITH CSV HEADER;
...
\echo Dumping table measurement_label_version
\copy (SELECT t0.* FROM measurement_label_version AS t0  WHERE TRUE) TO '$DATA_DIR/measurement_label_version.csv' WITH CSV HEADER;
...
\echo Dumping table measurement_record_version
\copy (SELECT t0.* FROM measurement_record_version AS t0  WHERE TRUE) TO '$DATA_DIR/measurement_record_version.csv' WITH CSV HEADER;
...
\echo Dumping table memodel_calibration_result_version
\copy (SELECT t0.* FROM memodel_calibration_result_version AS t0  WHERE TRUE) TO '$DATA_DIR/memodel_calibration_result_version.csv' WITH CSV HEADER;
\echo Dumping table memodel_version
\copy (SELECT t0.* FROM memodel_version AS t0  WHERE TRUE) TO '$DATA_DIR/memodel_version.csv' WITH CSV HEADER;
...
\echo Dumping table mtype_class_version
\copy (SELECT t0.* FROM mtype_class_version AS t0  WHERE TRUE) TO '$DATA_DIR/mtype_class_version.csv' WITH CSV HEADER;
...
\echo Dumping table mtype_classification_version
\copy (SELECT t0.* FROM mtype_classification_version AS t0  WHERE t0.authorized_public IS true) TO '$DATA_DIR/mtype_classification_version.csv' WITH CSV HEADER;
...
\echo Dumping table organization_version
\copy (SELECT t0.* FROM organization_version AS t0  WHERE TRUE) TO '$DATA_DIR/organization_version.csv' WITH CSV HEADER;
\echo Dumping table person
\copy (SELECT t0.* FROM person AS t0  WHERE TRUE) TO '$DATA_DIR/person.csv' WITH CSV HEADER;
\echo Dumping table person_version
\copy (SELECT t0.* FROM person_version AS t0  WHERE TRUE) TO '$DATA_DIR/person_version.csv' WITH CSV HEADER;
...
\echo Dumping table publication_version
\copy (SELECT t0.* FROM publication_version AS t0  WHERE TRUE) TO '$DATA_DIR/publication_version.csv' WITH CSV HEADER;
\echo Dumping table role
\copy (SELECT t0.* FROM role AS t0  WHERE TRUE) TO '$DATA_DIR/role.csv' WITH CSV HEADER;
\echo Dumping table role_version
\copy (SELECT t0.* FROM role_version AS t0  WHERE TRUE) TO '$DATA_DIR/role_version.csv' WITH CSV HEADER;
...
\echo Dumping table scientific_artifact_external_url_link_version
\copy (SELECT t0.* FROM scientific_artifact_external_url_link_version AS t0  WHERE TRUE) TO '$DATA_DIR/scientific_artifact_external_url_link_version.csv' WITH CSV HEADER;
...
\echo Dumping table scientific_artifact_publication_link_version
\copy (SELECT t0.* FROM scientific_artifact_publication_link_version AS t0  WHERE TRUE) TO '$DATA_DIR/scientific_artifact_publication_link_version.csv' WITH CSV HEADER;
\echo Dumping table scientific_artifact_version
\copy (SELECT t0.* FROM scientific_artifact_version AS t0  WHERE TRUE) TO '$DATA_DIR/scientific_artifact_version.csv' WITH CSV HEADER;
...
\echo Dumping table simulation_campaign_version
\copy (SELECT t0.* FROM simulation_campaign_version AS t0  WHERE TRUE) TO '$DATA_DIR/simulation_campaign_version.csv' WITH CSV HEADER;
...
\echo Dumping table simulation_execution_version
\copy (SELECT t0.* FROM simulation_execution_version AS t0  WHERE TRUE) TO '$DATA_DIR/simulation_execution_version.csv' WITH CSV HEADER;
...
\echo Dumping table simulation_generation_version
\copy (SELECT t0.* FROM simulation_generation_version AS t0  WHERE TRUE) TO '$DATA_DIR/simulation_generation_version.csv' WITH CSV HEADER;
...
\echo Dumping table simulation_result_version
\copy (SELECT t0.* FROM simulation_result_version AS t0  WHERE TRUE) TO '$DATA_DIR/simulation_result_version.csv' WITH CSV HEADER;
\echo Dumping table simulation_version
\copy (SELECT t0.* FROM simulation_version AS t0  WHERE TRUE) TO '$DATA_DIR/simulation_version.csv' WITH CSV HEADER;
...
\echo Dumping table single_neuron_simulation_version
\copy (SELECT t0.* FROM single_neuron_simulation_version AS t0  WHERE TRUE) TO '$DATA_DIR/single_neuron_simulation_version.csv' WITH CSV HEADER;
...
\echo Dumping table single_neuron_synaptome_simulation_version
\copy (SELECT t0.* FROM single_neuron_synaptome_simulation_version AS t0  WHERE TRUE) TO '$DATA_DIR/single_neuron_synaptome_simulation_version.csv' WITH CSV HEADER;
\echo Dumping table single_neuron_synaptome_version
\copy (SELECT t0.* FROM single_neuron_synaptome_version AS t0  WHERE TRUE) TO '$DATA_DIR/single_neuron_synaptome_version.csv' WITH CSV HEADER;
...
\echo Dumping table skeletonization_campaign_version
\copy (SELECT t0.* FROM skeletonization_campaign_version AS t0  WHERE TRUE) TO '$DATA_DIR/skeletonization_campaign_version.csv' WITH CSV HEADER;
...
\echo Dumping table skeletonization_config_generation_version
\copy (SELECT t0.* FROM skeletonization_config_generation_version AS t0  WHERE TRUE) TO '$DATA_DIR/skeletonization_config_generation_version.csv' WITH CSV HEADER;
\echo Dumping table skeletonization_config_version
\copy (SELECT t0.* FROM skeletonization_config_version AS t0  WHERE TRUE) TO '$DATA_DIR/skeletonization_config_version.csv' WITH CSV HEADER;
...
\echo Dumping table skeletonization_execution_version
\copy (SELECT t0.* FROM skeletonization_execution_version AS t0  WHERE TRUE) TO '$DATA_DIR/skeletonization_execution_version.csv' WITH CSV HEADER;
\echo Dumping table species
\copy (SELECT t0.* FROM species AS t0  WHERE TRUE) TO '$DATA_DIR/species.csv' WITH CSV HEADER;
\echo Dumping table species_version
\copy (SELECT t0.* FROM species_version AS t0  WHERE TRUE) TO '$DATA_DIR/species_version.csv' WITH CSV HEADER;
\echo Dumping table strain
\copy (SELECT t0.* FROM strain AS t0  WHERE TRUE) TO '$DATA_DIR/strain.csv' WITH CSV HEADER;
\echo Dumping table strain_version
\copy (SELECT t0.* FROM strain_version AS t0  WHERE TRUE) TO '$DATA_DIR/strain_version.csv' WITH CSV HEADER;
...
\echo Dumping table subject_version
\copy (SELECT t0.* FROM subject_version AS t0  WHERE TRUE) TO '$DATA_DIR/subject_version.csv' WITH CSV HEADER;
\echo Dumping table transaction
\copy (SELECT t0.* FROM transaction AS t0  WHERE TRUE) TO '$DATA_DIR/transaction.csv' WITH CSV HEADER;
\echo Dumping table transaction_changes
\copy (SELECT t0.* FROM transaction_changes AS t0  WHERE TRUE) TO '$DATA_DIR/transaction_changes.csv' WITH CSV HEADER;
...
\echo Dumping table usage_version
\copy (SELECT t0.* FROM usage_version AS t0  WHERE TRUE) TO '$DATA_DIR/usage_version.csv' WITH CSV HEADER;
...
\echo Dumping table validation_result_version
\copy (SELECT t0.* FROM validation_result_version AS t0  WHERE TRUE) TO '$DATA_DIR/validation_result_version.csv' WITH CSV HEADER;
\echo Dumping table validation_version
\copy (SELECT t0.* FROM validation_version AS t0  WHERE TRUE) TO '$DATA_DIR/validation_version.csv' WITH CSV HEADER;
