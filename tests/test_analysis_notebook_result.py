...
ADMIN_ROUTE = "/admin/analysis-notebook-result"
MODEL = AnalysisNotebookResult


@pytest.fixture
def json_data(analysis_notebook_result_json_data):
    return analysis_notebook_result_json_data


@pytest.fixture
def model(analysis_notebook_result):
    return analysis_notebook_result
...
def _assert_read_response(data, json_data):
    ...
    assert data["type"] == EntityType.analysis_notebook_result
